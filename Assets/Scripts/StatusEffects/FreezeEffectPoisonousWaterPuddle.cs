...
namespace StatusEffects {
    ...
    public class FreezeEffectPoisonousWaterPuddle : MonoBehaviour, IEffectBehaviour {
        ...
        private Spikes spikesComponent;
        ...
        public void Enable() {
            ...
            spikesComponent = GetComponent<Spikes>();
            spikesComponent.damage = 0;
