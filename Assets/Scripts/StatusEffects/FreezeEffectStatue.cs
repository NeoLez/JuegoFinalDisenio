...
namespace StatusEffects {
    [RequireComponent(typeof(MovingStatue))]
    public class FreezeEffectStatue : MonoBehaviour, IEffectBehaviour {
        ...
        private MovingStatue statueComponent;
        ...
        public void Enable() {
            ...
            statueComponent = GetComponent<MovingStatue>();
            statueComponent.freeze = true;
